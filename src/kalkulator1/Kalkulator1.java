...
public class Kalkulator1 implements ActionListener{
    double variabel1=0, variabel2=0,hasil=0;
    int operator;
   
    JFrame frame=new JFrame("Kalkuator");
    ...
    JButton buttonTheree = new JButton("3");
    ...
    Kalkulator1(){
        ...
        public void prepareGui(){
          ...
          public void addComponents(){
              ...
              buttonTheree.setBounds(150,290,60,40);
              buttonTheree.setFont(new Font("Arial",Font.BOLD,20));
              buttonTheree.setFocusable(false);
              frame.add(buttonTheree);
          ...
          public void addActionEvent(){
              ...
              buttonTheree.addActionListener(this);
